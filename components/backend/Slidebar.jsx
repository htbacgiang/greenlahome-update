...
const NAV_GROUPS = [
  ...
  },
  {
    label: "Sản phẩm",
    items: [
      { title: "Sản phẩm", icon: Package, href: "/dashboard/san-pham" },
      { title: "Thêm sản phẩm", icon: FolderPlus, href: "/dashboard/them-san-pham" },
    ],
  },
  {
    label: "Đơn hàng & Khách hàng",
    items: [
      { title: "Đơn hàng", icon: ClipboardList, href: "/dashboard/dat-hang" },
      { title: "Khách hàng", icon: Users2, href: "/dashboard/khach-hang" },
    ],
  },
  {
    label: "Tài khoản",
      ...
      <div className="flex items-center h-16 border-b border-gray-100 dark:border-gray-800 shrink-0 px-2 gap-2">
        ...
        <button
          ...
          className={`
            ...
            w-8 h-8 rounded-lg
            text-gray-400 hover:text-green-600 hover:bg-green-600/10
              ...
              {group.items.map((item) => {
                ...
                return (
                  ...
                  >
                    ...
                    {active && !collapsed && (
                      <span className="absolute left-0 top-1/2 -translate-y-1/2 w-0.5 h-5 bg-green-600 rounded-r-full" />
                    )}
                    ...
                    {!collapsed && (
                      <>
                        ...
                        {active && (
                          <ChevronRight className="w-3.5 h-3.5 ml-auto text-green-600/60 dark:text-green-400/60" />
                        )}
                      </>
                    )}
                  </Link>
