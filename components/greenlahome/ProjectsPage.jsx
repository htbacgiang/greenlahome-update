...
export default function ProjectsPage({ showHero = true }) {
    ...
    <div className={showHero ? "min-h-screen" : ""}>
      ...
      <section className="py-8 bg-q8-primary-50 relative">
        <div className="container mx-auto px-4">
          {/* Filter Bar */}
          <div ref={filterBarRef} className="bg-white p-6 shadow-xl mb-12 border border-q8-primary-300 rounded-2xl">
            {/* Category Filters */}
            <div className="flex flex-wrap gap-2 justify-center">
              {filterCategories.map((category) => (
                <button
                  ...
                  className={`px-6 py-2.5 rounded-full text-sm font-bold transition-all duration-300 ${activeFilter === category.id
                    ? 'active-filter-btn shadow-lg transform scale-105'
                    : 'bg-white text-q8-primary-700 border border-q8-primary-200 hover:border-q8-primary-400 hover:bg-q8-primary-50 shadow-sm disabled:opacity-50'
                    }`}
                >
                  ...
                  for (let i = startPage; i <= endPage; i++) {
                    pages.push(
                      <button
                        ...
                        className={`w-10 h-10 rounded-full font-bold transition-all duration-300 flex items-center justify-center ${i === currentPage
                          ? "active-filter-btn shadow-lg scale-110"
                          : "bg-white text-q8-primary-700 border border-q8-primary-200 hover:border-q8-primary-400 hover:bg-q8-primary-50"
                          }`}
                      >
                        {i}
                      </button>
