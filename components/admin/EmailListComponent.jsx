...
const EmailListComponent = () => {
  ...
  const handleExport = async () => {
    try {
      ...
      a.href = url;
      a.download = `greenlahome-khach-hang-${new Date().toISOString().split('T')[0]}.csv`;
    ...
    <div className="p-6">
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-gray-800 mb-2">
          Quản lý Khách hàng GreenlaHome
        </h1>
        <p className="text-gray-600">
          Quản lý danh sách khách hàng quan tâm đến sản phẩm và dịch vụ nội thất
        </p>
      </div>
