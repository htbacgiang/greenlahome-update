// pages/thiet-ke-noi-that-chung-cu.js
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      },
      {
        ...
        item: "https://greenlahome.vn/thiet-ke-noi-that-chung-cu",
      },
    ],
  };
    ...
    <DefaultLayout>
      ...
      <div className="relative w-full h-[30vh] md:h-[40vh]">
        ...
        <div className="absolute bottom-6 left-0 md:bottom-8 md:left-8 right-0 flex flex-col justify-end items-start text-white px-6 md:px-10 lg:px-16 pb-3">
          ...
          <p className="text-base md:text-lg mt-2 max-w-5xl text-gray-200">
            Dịch vụ thiết kế & thi công nội thất chung cư chuyên nghiệp từ Greenlahome. Giải pháp tối ưu không gian thông minh, hiện đại, đúng gu & ngân sách. Tư vấn miễn phí!
          </p>
        </div>
      </div>
