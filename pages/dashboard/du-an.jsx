...
import AddProjectForm from '../../components/greenlahome/AddProjectForm';
import ProjectsListDashboard from '../../components/greenlahome/ProjectsListDashboard';
              ...
              {projects.length === 0 ? (
                <div className="bg-white shadow-lg rounded-lg p-8 text-center">
                  ...
                  <p className="text-gray-500 mb-4">
                    Database chưa có dữ liệu dự án. Hãy thêm dự án đầu tiên!
                  </p>
